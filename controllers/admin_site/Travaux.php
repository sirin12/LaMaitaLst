...
class Travaux extends Admin_Controller {
	...
	function form($id = false) {
		...
		if($id){
            ...
            $data['user_id']=$current_admin['id'];
		}
		
		$this->form_validation->set_rules('travaux', 'lang:travaux', 'trim');
		// Validate the form
    ...
    function delete($id) {
        ...
        $projets_id=$this->md_commun->get_row('travaux',array('id'=>$id));
        ...
        if ($projets_id) {
			...
			$projets_id = $this->md_commun->save('travaux',$save);
