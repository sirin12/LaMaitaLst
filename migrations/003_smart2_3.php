...
class Migration_smart2_3 extends CI_migration {
    ...
    public function up() {
        ...
        $settings = $this->settings_model->get_settings('smart');

        if (empty($settings)) {
            if (file_exists(FCPATH . 'smart/config/smart.php')) {
                include(FCPATH . 'smart/config/smart.php');
            ...
            //submit the settings
            $this->settings_model->save_settings('smart', $config);
    ...
    public function down() {
        ...
        $this->load->model('settings_model');
        $this->settings_model->delete_settings('smart');
    }
