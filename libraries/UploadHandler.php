...
class UploadHandler {
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . '/uploads/models/',

            'upload_url' => $this->get_full_url() . '/uploads/models/',
    ...
    protected function generate_unique_filename($filename = "") {
        ...
        return md5($filename).date('Y_m_d_H_i_s') . $extension;
