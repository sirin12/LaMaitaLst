                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="<?php echo admin_url('Corrections/form/' . $id);?>" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
										<div class="col-sm-6 col-lg-3">
											<div class="form-check form-check-radio">
												<label>
													<input name="etat_correction" type="radio" value="1" <?php if($etat_correction==1) echo 'checked';?> <?php if($id) echo 'disabled';?> />
													<span>Crée</span>
												</label>
											</div>
										</div>
								...
								<div class="form-group form-float">
									<label class="form-label"><b>Etat du tache</b></label>
                                    <div class="row">
										<div class="col-sm-6 col-lg-3">
											<div class="form-check form-check-radio">
												<label>
													<input name="etat_urgent" type="radio" value="1" <?php if($etat_urgent==1) echo 'checked';?> />
													<span>Tache n'est pas urgent</span>
												</label>
											</div>
										</div>
										<div class="col-sm-6 col-lg-3">
								...
								<div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        <div class="form-group default-select select2Style">
											<?php $projets=$this->md_commun->fetch('projets',array(),'asc',10000,0);?>
								...
								<div class="form-group form-float col-md-4" id="etages_id">
                                    ...
                                    <div class="form-line">
                                        <div class="form-group default-select select2Style">
											<?php $etages=$this->md_commun->fetch('etages',array(),'asc',10000,0);?>
								...
								<div class="form-group form-float col-md-4" id="appartements_id">
                                    ...
                                    <div class="form-line">
                                        <div class="form-group default-select select2Style">
											<?php $appartements=$this->md_commun->fetch('appartements',array(),'asc',10000,0);?>
								...
								<div class="form-group form-float col-md-6">
									<label class="form-label"><b>Travaux</b></label>
                                    <div class="form-line">
                                        <div class="form-group default-select select2Style">
		...
		$id_admin=$current_admin['id']; if ($current_admin['access'] == 'Admin') {
            ...
            $travaux = $this->md_commun->fetch('travaux', array('etat' => 1, 'user_id' => $id_admin), 'asc', 100, 0);
											...
											<select class="form-control select2" data-placeholder="Select" name="travaux_id" onchange="fetch_societes(this.value)">
												<option value="">Seclectionner Travaux</option>
								...
								<div class="form-group form-float col-md-6" id="societes_id">
                                    ...
                                    <div class="form-line">
                                        <div class="form-group default-select select2Style">
											<?php $societes=$this->md_commun->fetch('societes',array('travaux_id'=>$travaux_id),'asc',10000,0);?>
