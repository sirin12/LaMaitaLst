                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style ">
							...
							<li class="breadcrumb-item bcrumb-1">
                                <a href="<?php echo admin_url('Projets/Etages/'.$projet_id.'/'.$blocs_id);?>">Etages</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <strong>Etages</strong></h2>
                         
                        </div>
                        <div class="body">
                            <form id="form_validation" method="POST" action="<?php echo admin_url('Projets/form_etages/'.$projet_id.'/'.$blocs_id.'/' . $id);?>" enctype="multipart/form-data">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="etages" value="<?php echo $etages;?>" required>
                                        <label class="form-label">Etages</label>
                                    </div>
                                </div>
								<div class="row">
