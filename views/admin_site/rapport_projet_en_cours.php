...
$corrections_bloc=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etat'=>1,'afficher'=>1,'etat_correction'=>4),'asc',100,0);
//correction bloc
if($corrections_bloc){?>
...
$corrections_etage=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'etat'=>1,'afficher'=>1,'etat_correction'=>4),'asc',100,0);
//correction etage
...
$corrections_app=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'etat'=>1,'afficher'=>1,'etat_correction'=>4),'asc',100,0);
//correction app
if($corrections_app){?>
<table>
	<thead>
	...
	$corrections_travaux=$corrections=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>2,'etat_correction'=>4),'asc',100,0);
	//correction travaux
	...
	<tr>
		<td align="left">
			...
			<?php if($corrections){foreach($corrections as $correction){
				...
				<li style="list-style:square;<?php if($correction->etat_urgent==2) echo 'color:red';?>"><b><?php echo $correction->localisation;?></b> - <?php echo $correction->intitile;?> (<?php echo $etat;?>) <span style="color:red"><?php if($correction->etat_urgent==2) echo '<span class="label bg-red shadow-style">Urgent</span>';?></span>
	...
	<?php }
	$corrections_travaux2=$corrections=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>1,'etat_correction'=>4),'asc',100,0);
	//correction travaux
...
<?php if($blocs){foreach($blocs as $bloc){
$corrections_bloc=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etat'=>1,'afficher'=>1,'etat_correction !='=>3),'asc',100,0);
//correction bloc
if($corrections_bloc){?>
<?php $etages=$this->md_commun->fetch('etages',array('projet_id'=>$projet_id,'blocs_id'=>$bloc->id,'etat'=>1),'asc',100,0);?>
<?php if($etages){foreach($etages as $etage){
$corrections_etage=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'etat'=>1,'afficher'=>1,'etat_correction !='=>3),'asc',100,0);
//correction etage
if($corrections_etage){
$apps=$this->md_commun->fetch('appartements',array('projet_id'=>$projet_id,'blocs_id'=>$bloc->id,'etages_id'=>$etage->id,'etat'=>1),'asc',100,0);?>
<?php if($apps){foreach($apps as $app){
$corrections_app=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'etat'=>1,'afficher'=>1,'etat_correction !='=>3),'asc',100,0);
//correction app
if($corrections_app){?>
	...
	$corrections_travaux1=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>2,'etat_correction'=>4),'asc',100,0);
	//correction travaux
	...
	$corrections_travaux3=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'afficher'=>1,'etat_urgent !='=>2,'etat_correction'=>4),'asc',100,0);
	//correction travaux
...
ob_end_clean();
		$mpdf=new mpdf('en','a4','','',10,15,35,20,0,5); 
		...
		$mpdf->Output('rapport_en_cours.pdf', 'I');
		?>