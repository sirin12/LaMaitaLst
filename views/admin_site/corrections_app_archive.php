                                ...
                                <table id="tableExport"
									...
									<?php if($corrections){foreach($corrections as $cor){
                                        ...
                                        <tr>
											...
											<a href="<?php echo admin_url('projets/repaire_correction/'.$projet_id.'/'.$bloc_id.'/'.$etage_id.'/'.$appartements_id.'/'.$cor->id);?>" class="btn bg-teal waves-effect"><i class="fas fa-spinner"></i> <span class="btn_desctopp">Repair</span></a>
											</td>
                                        </tr>
                                    <?php }}?>    
                                    </tbody>
