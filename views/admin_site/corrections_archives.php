                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <a href="<?php echo admin_url('Corrections/delete_all/');?>" class="btn bg-danger waves-effect" style="float:right"><i class="fa fa-trash" style="padding-top: 5px;font-size: 16px;"></i> vider</a>
                                ...
                                <table id="tableExport"
									...
									<?php if($corrections){foreach($corrections as $cor){
                                        ...
                                        <tr>
                                            ...
                                            <td>
											<a href="<?php echo admin_url('Corrections/repaire/'.$cor->id);?>" class="btn bg-teal waves-effect"><i class="fas fa-spinner"></i> <span class="btn_desctopp">Repaire</span></a>
                                            <a href="<?php echo admin_url('Corrections/supprimer/'.$cor->id);?>" class="btn bg-danger waves-effect"><i class="fas fa-trash"></i> <span class="btn_desctopp">Supprimer</span></a>
											</td>
                                        </tr>
                                    <?php }}?>    
                                    </tbody>
