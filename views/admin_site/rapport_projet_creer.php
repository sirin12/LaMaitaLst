...
$corrections_bloc=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etat'=>1,'afficher'=>1,'etat_correction'=>1),'asc',100,0);
//correction bloc
if($corrections_bloc){?>
...
$corrections_etage=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'etat'=>1,'afficher'=>1,'etat_correction'=>1),'asc',100,0);
//correction etage
...
$corrections_app=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'etat'=>1,'afficher'=>1,'etat_correction'=>1),'asc',100,0);
//correction app
if($corrections_app){?>
<table>
	<thead>
	...
	$corrections_travaux=$corrections=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>2,'etat_correction'=>1),'asc',100,0);
	//correction travaux
	...
	<?php }
	$corrections_travaux2=$corrections=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>1,'etat_correction'=>1),'asc',100,0);
	//correction travaux
...
if($corrections_app){?>
	...
	$corrections_travaux1=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>2,'etat_correction'=>1),'asc',100,0);
	//correction travaux
	...
	$corrections_travaux3=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'afficher'=>1,'etat_urgent !='=>2,'etat_correction'=>1),'asc',100,0);
	//correction travaux
...
ob_end_clean();
		...
		$mpdf->Output('rapport_creer.pdf', 'I');
		?>