...
$corrections_bloc=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>2,'etat_correction !='=>3),'asc',1000,0);
//correction bloc
if($corrections_bloc){?>
...
$corrections_etage=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>2,'etat_correction !='=>3),'asc',1000,0);
//correction etage
...
$corrections_app=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>2,'etat_correction !='=>3),'asc',1000,0);
//correction etage
if($corrections_app){?>
<table>
	<thead>
...
<?php if($blocs){foreach($blocs as $bloc){
$corrections_bloc=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>2,'etat_correction !='=>3),'asc',100,0);
//correction bloc
if($corrections_bloc){?>
<?php $etages=$this->md_commun->fetch('etages',array('projet_id'=>$projet_id,'blocs_id'=>$bloc->id,'etat'=>1),'asc',100,0);?>
<?php if($etages){foreach($etages as $etage){
$corrections_etage=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>2,'etat_correction !='=>3),'asc',100,0);
//correction etage
if($corrections_etage){?>
...
<?php if($apps){foreach($apps as $app){
$corrections_app=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'etat'=>1,'afficher'=>1,'etat_urgent'=>2,'etat_correction !='=>3),'asc',100,0);
//correction etage
if($corrections_app){?>
	<?php $ic=0;?>
