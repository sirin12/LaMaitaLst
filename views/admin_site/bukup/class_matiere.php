            ...
            <div class="content container-fluid">
                 ...
                 <div class="row">
                    ...
                    <div class="col-sm-7 col-7 text-right m-b-30">
                        <a href="#" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#add_coefficient"><i class="fa fa-plus"></i> Ajouter coefficient</a>
                    </div>
                </div>
                            ...
                            <table class="table table-striped custom-table m-b-0 datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
										...
										<td><?php if($coefficient->enseignants_id) {$enseignantsid=$this->Enseignants_model->get($coefficient->enseignants_id);?><?php if($enseignantsid) echo $enseignantsid->nom.' '.$enseignantsid->prenom;}else echo '-';?></td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
												<?php $current_admin = $this->session->userdata('users');
												if(($current_admin['role']==1)){?>
													<a class="dropdown-item" href="<?php echo admin_url('Classs/notes/'.$coefficient->class_id.'/'.$coefficient->id);?>" title="Notes"><i class="fa fa-pencil m-r-5"></i> Notes</a>
												<?php }?>
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="<?php echo '#enseignants_coefficient'.$coefficient->id;?>" title="Enseignants"><i class="fa fa-pencil m-r-5"></i> Enseignants</a>
