                ...
                <div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">Ajout Etudiant</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="<?php echo admin_url('Dashboard');?>">Dashboard</a></li>
								<li class="list-inline-item"><a href="<?php echo admin_url('Etudiants');?>">Etudiants</a></li>
								<li class="list-inline-item"> Ajouter Etudiant</li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">	
									<?php echo form_open_multipart($this->config->item('admin_folder') . '/Etudiants/form/' . $id); ?>
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="form-group custom-mt-form-group">
													<select name="class">
														...
														<option value="<?php echo $class->id;?>" <?php if($class==$class->id) echo 'selected';?>><?php echo $class->name;?></option>
														<?php }}?>
													 </select>
													<label class="control-label">Class</label><i class="bar"></i>
												</div>
