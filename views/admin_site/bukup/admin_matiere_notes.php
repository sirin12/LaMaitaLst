<div class="page-wrapper"> <!-- content -->
            <div class="content container-fluid">
                ...
                <div class="row">
					...
					<?php if($coiefficient_id->valide_admin==0){?>
						<a href="#" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#<?php echo 'validation'.$coiefficient_id->id;?>"> Valider </a>
					<?php }?>
					<a href="<?php echo admin_url('Matiere_admin');?>" class="btn btn-primary btn-rounded" > Retour </a>
            ...
            <div class="modal-dialog" style="max-width:75%">
                <div class="modal-content modal-md">
                    ...
                    <div class="modal-body">
                        <?php echo form_open_multipart($this->config->item('admin_folder') . '/Matiere_admin/form_note/'.$coiefficient_id->id); ?>
		...
		<div id="edit_note" class="modal" role="dialog">
            <div class="modal-dialog" style="max-width:75%">
                <div class="modal-content modal-md">
                    ...
                    <div class="modal-body">
                        <?php echo form_open_multipart($this->config->item('admin_folder') . '/Matiere_admin/form_note_edit/'.$coiefficient_id->id); ?>
                ...
                <div class="modal-content modal-md">
                    ...
                    <div class="modal-body card-box">
                        ...
                        <div class="m-t-20 text-left">
                            ...
                            <a href="<?php echo admin_url('Matiere_admin/valider/'.$coiefficient_id->id);?>" class="btn btn-danger">Valider</a>
                        </div>
                    </div>
                </div>
            </div>
