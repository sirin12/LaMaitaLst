...
<head>
	...
	th,td{text-align:left;padding-left:15px; line-height:2}
...
<?php $etages=$this->md_commun->fetch('etages',array('projet_id'=>$projet_id,'blocs_id'=>$bloc->id,'id'=>$etage_id,'etat'=>1),'asc',100,0);?>
...
$corrections_app=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'etat'=>1,'etat_correction !='=>3),'asc',100,0);
//correction etage
if($corrections_app){?>
<table>
	<tbody>
	...
	$corrections_travaux1=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'etat_urgent'=>2,'etat_correction !='=>3),'asc',100,0);
	//correction travaux
	if($corrections_travaux1){?>
	
			<u style="color:red;"><?php echo $trav->travaux;?></u><br>
			<?php if($corrections_travaux1){foreach($corrections_travaux1 as $correction){
				...
				<tr>
				<td align="left" style="list-style:square;color:red"><b><?php echo $correction->localisation;?></b> - <?php echo $correction->intitile;?> (<?php echo $etat;?>) <?php if($correction->etat_urgent==2) echo '<b style="color:red">(URGENT)</b>';?>
			...
			<?php }}?>
	<?php }
	$corrections_travaux2=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'etat_urgent'=>1,'etat_correction !='=>3),'asc',100,0);
	//correction travaux
	if($corrections_travaux2){?>
			<u><?php echo $trav->travaux;?></u><br>
			<?php if($corrections_travaux2){foreach($corrections_travaux2 as $correction){
				$historiques=$this->md_commun->fetch('corrections_historiques',array('correction_id'=>$correction->id,'etat'=>1),'asc',100,0);
				if($correction->etat_correction==1){$etat='Crée';}elseif($correction->etat_correction==4){$etat='En cours';}elseif($correction->etat_correction==2){$etat='Corrigée';}elseif($correction->etat_correction==3){$etat='Validé';}?>
				<tr>
				<td align="left" style="list-style:square;float:left;width:100%;"><b><?php echo $correction->localisation;?></b> - <?php echo $correction->intitile;?> (<?php echo $etat;?>) <?php if($correction->etat_urgent==2) echo '<b style="color:red">(URGENT)</b>';?>
				<?php //if($historiques){foreach($historiques as $hit){echo '<br><span style="color:red;text-decoration:underline;margin-left-left:10px;">'.$hit->observation_leve.'</span>'; }}?>
				</td>
				</tr>
			<?php }}?>
	<?php }
	$corrections_travaux3=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'etat_correction'=>3),'asc',100,0);
	//correction travaux
	if($corrections_travaux3){?>
			<u style="color:blue;"><?php echo $trav->travaux;?></u><br>
			<?php if($corrections_travaux3){foreach($corrections_travaux3 as $correction){
				$historiques=$this->md_commun->fetch('corrections_historiques',array('correction_id'=>$correction->id,'etat'=>1),'asc',100,0);
				if($correction->etat_correction==1){$etat='Crée';}elseif($correction->etat_correction==4){$etat='En cours';}elseif($correction->etat_correction==2){$etat='Corrigée';}elseif($correction->etat_correction==3){$etat='Validé';}?>
				<tr>
				<td align="left" style="list-style:square;color:blue;"><b><?php echo $correction->localisation;?></b> - <?php echo $correction->intitile;?> (<?php echo $etat;?>) 
...
if($corrections_app){?>
	...
	if($corrections_travaux1){?>
			<?php if($corrections_travaux1){foreach($corrections_travaux1 as $correction){
				...
				<td align="left" style="width:220px;padding-right:10px;float:left; padding-bottom:10px;">
					<img src="<?php echo uploads('images/medium/'.$correction->image);?>" width="220" height="220" border="0" />
					<div align="left" style="border:solid 1px #585499;width:100%;float:left;background:#e9e9e9;height:30px;font-size:10px;<?php if($correction->etat_urgent==2) echo 'color:red;';?>">
						<b>[<?php echo $app->appartements;?>] <?php echo $correction->localisation;?></b> - <?php echo $correction->intitile;?> (<?php echo $etat;?>) <?php if($correction->etat_urgent==2) echo '<b style="color:red">(URGENT)</b>';?>
					</div>	
				</td>
	...
	if($corrections_travaux2){?>
			...
			<?php if($corrections_travaux2){foreach($corrections_travaux2 as $correction){
				...
				<td align="left" style="width:220px;padding-right:10px;float:left; padding-bottom:10px">
					<img src="<?php echo uploads('images/medium/'.$correction->image);?>" width="220" height="220" border="0" />
					<div style="border:solid 1px #585499;background:#e9e9e9;height:30px;font-size:10px;<?php if($correction->etat_urgent==2) echo 'color:red;';?>">
						<b>[<?php echo $app->appartements;?>] <?php echo $correction->localisation;?></b> - <?php echo $correction->intitile;?> (<?php echo $etat;?>) <?php if($correction->etat_urgent==2) echo '<b style="color:red">(URGENT)</b>';?>
					</div>	
				</td>
				<?php if($ic%3==0) echo '</tr><tr>';?>
	...
	if($corrections_travaux3){?>
			<?php if($corrections_travaux3){foreach($corrections_travaux3 as $correction){
				...
				<td align="left" style="width:220px;padding-right:10px;float:left; padding-bottom:10px;">
					<img src="<?php echo uploads('images/medium/'.$correction->image);?>" width="220" height="220" border="0" />
					<div align="left" style="border:solid 1px #585499;width:100%;float:left;background:#e9e9e9;height:30px;font-size:10px;color:blue;">
