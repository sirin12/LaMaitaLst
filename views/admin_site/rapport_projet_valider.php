...
<div style="float:left;width:100%">
	<div style="float:left;width:60%">
		<h4 style="text-align:left">CONSTAT ET PROGRAMME DES TRAVAUX</h4><br>
	</div>
...
<table>
	...
	$corrections_travaux=$corrections=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'afficher'=>1,'etat_correction'=>3),'asc',100,0);
	//correction travaux
	...
	<tr>
		<td align="left">
			...
			<?php if($corrections){foreach($corrections as $correction){
				...
				<li style="list-style:square;color:blue"><b><?php echo $correction->localisation;?></b> - <?php echo $correction->intitile;?> (<?php echo $etat;?>) <span style="color:red"><?php if($correction->etat_urgent==2) echo '<span class="label bg-red shadow-style">Urgent</span>';?></span></li>
			<?php }}?>
		</td>
	</tr>
	<?php }?>
...
if($corrections_app){?>
	...
	$corrections_travaux1=$this->md_commun->fetch('corrections',array('projet_id'=>$projet_id,'bloc_id'=>$bloc->id,'etage_id'=>$etage->id,'appartements_id'=>$app->id,'travaux_id'=>$trav->id,'etat'=>1,'afficher'=>1,'etat_correction'=>3),'asc',100,0);
	//correction travaux
...
ob_end_clean();
		...
		$mpdf->Output('rapport_valider.pdf', 'I');
		?>