...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Thanks for using smart!</title>

        <link href="<?php echo base_url('assets/css/bootstrap.min.css'); ?>" type="text/css" rel="stylesheet"/>

    </head>
    <body>
        <div style="text-align:center; padding:20px;"><img src="<?php echo base_url('assets/img/login-logo.png'); ?>" alt="smart"/></div>
        <div class="container">
            <div class="row">
                <div class="span8 offset2">
                    ...
                    <?php if (!$is_writeable['config'] || !$is_writeable['root'] || !$is_writeable['uploads']): ?>
                        <div class="alert alert-error">
                            ...
                            <?php if (!$is_writeable['config']): ?>
                                <p><strong>Alert!</strong><br> The smart/config directory is not writable! This is required to generate the config files.</p>
                            <?php endif; ?>
                    ...
                    <fieldset>
                        ...
                        <div class="alert alert-info">
                            <h4>Note&hellip;</h4>
                            <p>Installing smart will not create a database. It will simply fill your existing database with the appropriate tables and records required to run.</p>
                        </div>
                    ...
                    <p>
                        <button type="submit" class="btn btn-large btn-primary">Install smart!</button>
                    </p>
                    </form>
                </div>
            </div>
            <hr>
            <div class="footer">
                <div style="text-align:center;"><a href="http://smartdv.com" target="_blank"><img src="<?php echo base_url('assets/img/driven-by-smart.png'); ?>" alt="Driven By smart"></a></div>
            </div>
    </body>
</html>